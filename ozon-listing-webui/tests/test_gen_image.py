...
# 让 `import backend.gen_image` 可用（backend 在 ozon-listing-webui = tests 的 parents[1]）
sys.path.insert(0, str(Path(__file__).resolve().parents[1]))
from backend.gen_image import (  # noqa: E402
    LOCALIZE_PROMPT, SCENE_PROMPT, WHITE_MAIN_PROMPT, GenImageConfig, build_create_payload, build_edit_request,
    build_infographic_prompt, create_image, edit_image, generate_main, images_from_response,
    serialize_multipart,
)
