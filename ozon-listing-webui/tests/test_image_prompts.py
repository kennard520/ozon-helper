...
from backend.ai_card import build_image_prompt_input, parse_image_prompts
...
def tearDownModule():
    ...
    import backend.app_service as _svc; importlib.reload(_svc)
    import backend.main as _main; importlib.reload(_main)
