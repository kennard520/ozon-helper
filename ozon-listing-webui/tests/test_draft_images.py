...
from backend.store import DEFAULT_DB, Store, utc_now_iso
from backend.drafts import create_draft_from_url, dumps_json, loads_json
...
class DraftImagesTest(unittest.TestCase):
    ...
    def test_backfill_migration(self):
        ...
        self.store._backfill_draft_images()
