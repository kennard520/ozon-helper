...
export const api = {
  ...
  draftPipeline: (id) => req('GET', `/api/drafts/${id}/pipeline`),
  draftPipelineNext: (id) => req('GET', `/api/drafts/${id}/pipeline/next`),
  draftPipelineRetry: (id, step_id) => req('POST', `/api/drafts/${id}/pipeline/retry`, { step_id }),
  draftPipelineSkip: (id, step_id, reason = '') => req('POST', `/api/drafts/${id}/pipeline/skip`, { step_id, reason }),
  draftPipelineCancel: (id, step_id, reason = '') => req('POST', `/api/drafts/${id}/pipeline/cancel`, { step_id, reason }),
  ...
  deleteDraft: (id, opts = {}) => req('DELETE', `/api/drafts/${id}${opts.scope ? `?scope=${encodeURIComponent(opts.scope)}` : ''}`),
  ...
  submitTextJob: (id) => req('POST', `/api/drafts/${id}/generate-all`),
  getTextJob: (jobId) => req('GET', `/api/text-jobs/${jobId}`),
  getLatestTextJob: (id) => req('GET', `/api/drafts/${id}/text-job/latest`),
  ...
  storeStats: (store_client_id) => req('GET', `/api/stores/stats${_sq(store_client_id)}`),
